...
<div class="settings-container max-w-4xl">
    ...
    <form class="space-y-8">
            ...
            <div class="p-8 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <input type="text" value="Ayaka Josei Center" class="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-sm font-bold focus:outline-none focus:border-[#da291c] transition-all">
                    </div>
                    <div class="space-y-2">
                        <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Tagline / Slogan</label>
                        <input type="text" value="Lembang Pelatihan Kerja dan Bahasa Jepang Terpercaya" class="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-sm font-bold focus:outline-none focus:border-[#da291c] transition-all">
                    </div>
                </div>
                <div class="space-y-2">
                    <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest">Deskripsi Meta</label>
                    <textarea rows="3" class="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-sm font-bold focus:outline-none focus:border-[#da291c] transition-all">Pusat pelatihan kerja dan pengembangan bahasa Jepang unggulan untuk wanita yang ingin berkarir di Jepang.</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="p-8 grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" value="https://instagram.com/ayakajosei" class="w-full pl-12 pr-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-sm font-bold focus:outline-none focus:border-[#da291c] transition-all">
                    </div>
                </div>
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" value="https://facebook.com/ayakajosei" class="w-full pl-12 pr-5 py-3.5 bg-slate-50 border border-slate-100 rounded-xl text-sm font-bold focus:outline-none focus:border-[#da291c] transition-all">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end gap-4">
            <button type="button" class="px-8 py-4 bg-slate-100 text-slate-400 font-black text-sm uppercase tracking-widest rounded-2xl hover:bg-slate-200 transition-all">Batal</button>
