        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y divide-slate-50">
                    @php
                        $articles = [
                            ['title' => 'Tips Lulus JLPT N4 dalam 3 Bulan', 'status' => 'Published', 'views' => 2450],
                            ['title' => 'Daftar Kosa Kata Kaigo Esensial', 'status' => 'Published', 'views' => 1800],
                            ['title' => 'Pengalaman Kerja di Osaka', 'status' => 'Draft', 'views' => 0],
                        ];
                    @endphp
                        ...
                        <td class="px-8 py-6">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="text-[10px] text-slate-400 font-medium uppercase tracking-widest">Update: 2 Hari Lalu</div>
                                </div>
                            </div>
                        </td>
                        <td class="px-8 py-6">
